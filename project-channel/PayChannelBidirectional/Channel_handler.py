...
from PayChannelBidirectional.SigConverter import get_byte_sign
...
if __name__ == '__main__':
    ...
    contract_address = "0x4a0e3953da67A985BB97Ce00e46329bb88eA5576"
    if int(port) == 5000:
        ...
        user = ChannelClass(_address="0xd7b02e3bdf2eddbb5793d4728eafa83ec8c07d0b",
                            _key="0x740b220f156da692ead7d9e7a1b281534cb90f6821f36628485f1d5a05056be9",
                            _contract_address=contract_address)
    # sign = user.sign_state(1, 18000, 2000)
    # print(user.check_sign(1, 18000, 2000, sign, user.address))
